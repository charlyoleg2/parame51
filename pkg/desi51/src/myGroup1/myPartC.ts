...
const pDef: tParamDef = {
	...
	params: [
		...
		pNumber('D2', 'mm', 40, 10, 100, 2),
		pNumber('D3', 'mm', 40, 10, 100, 2),
		pNumber('D4', 'mm', 40, 10, 100, 2),
		pNumber('L1', 'mm', 3, 1, 50, 1),
		pNumber('L2', 'mm', 3, 1, 50, 1),
		pNumber('L3', 'mm', 3, 1, 50, 1),
		pNumber('L4', 'mm', 3, 1, 50, 1),
		pNumber('H1', 'mm', 50, 10, 200, 10)
	],
	paramSvg: {
		D1: 'myPartC_side.svg',
		D2: 'myPartC_side.svg',
...
function pGeom(t: number, param: tParamVal): tGeom {
	...
	try {
		...
		// step-6 : any logs
		rGeome.logstr += `myPartC-length: ${ffix(param.L1)} mm\n`;
		rGeome.logstr += `myPartC-external-diameter: ${ffix(param.D1)} mm\n`;
		rGeome.logstr += `myPartC-internal-diameter: ${ffix(param.D1 - 2 * param.E1)} mm\n`;
